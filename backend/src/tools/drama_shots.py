...
def normalize_shot(slug: str, episode: int, raw: dict[str, Any]) -> dict[str, Any]:
    ...
    shot = {
        ...
        "duration": duration,
        "画面": str(raw.get("画面") or raw.get("still") or ""),
        "still": str(raw.get("still") or raw.get("画面") or ""),
        "motion": str(raw.get("motion") or ""),
        "shot_size": str(raw.get("shot_size") or raw.get("size") or ""),
        "audio_mode": str(raw.get("audio_mode") or ""),
        ...
        "size": raw.get("size") or raw.get("shot_size") or "",
