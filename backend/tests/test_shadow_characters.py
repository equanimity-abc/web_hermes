...
def test_atmospheric_eyes_not_face_locked():
    from tools.drama_characters import is_atmospheric_partial_face

    assert is_atmospheric_partial_face("月亮背面的眼睛") is True
    assert is_atmospheric_partial_face("嫦娥") is False
