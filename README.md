...
完整计划见根目录 [`ROADMAP.md`](./ROADMAP.md)。**当前主线：S0–S8（成片天花板与专业交付）**；P/D/Q/R 历史阶段已齐，细节见该文档后半。
...
- [x] R0–R8: 预设中心 / provider 插件 / 节点配置 / 重试熔断 / identity 闸 / 批量 / 快照 / 预算 / 验收清单（骨架）
- [ ] **S0**: 诚实层（预设与 registry 名实相符，UI 明示降级）
- [ ] **S1–S3**: 真出图 / 真 I2V / 真口型+TTS
- [ ] **S4–S8**: 性能、流水线补洞、导演 UX、Agent 检查点、交付工程